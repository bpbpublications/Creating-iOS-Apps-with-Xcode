...
extension Chore {
	static var sampleChores: [Chore] {
		...
		let c1 = Chore(name: "Pickup", location: "Bedroom", frequency: .daily, assignedTo: liam, isComplete: true)
		let c2 = Chore(name: "Make Bed", location: "Bedroom", frequency: .daily, assignedTo: liam, isComplete: true)
		let c3 = Chore(name: "Pickup", location: "Living space", frequency: .daily, assignedTo: maria, isArchived: true, dueDate: lastWeek)
